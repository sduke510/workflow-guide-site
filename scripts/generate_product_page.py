...
TEXT_FIELDS = [
    "page_title", "meta_description", "og_title", "og_description", "breadcrumb",
    "editorial_image_alt", "image_disclosure", "badge", "h1", "lead",
    "product_name", "product_summary", "cta", "reasons_title",
]
